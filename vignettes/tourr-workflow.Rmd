...
```{r tour_frame, eval=tourr_available, message=FALSE, warning=FALSE, fig.width=6, fig.height=5}
...
```{r compare_frame, eval=tourr_available, message=FALSE, warning=FALSE, fig.width=10, fig.height=5, out.width="100%"}
if (requireNamespace("tourr", quietly = TRUE) && exists("tour_history")) {
