...
#' @return The file path (invisibly).
#' @keywords internal
export_grid_csv <- function(cb_mod, data, resolution, proj_matrix = NULL, proj_info = NULL, predict_args = list(), file) {
  tryCatch({
...
#' @return The file path (invisibly).
#' @keywords internal
export_reproduce_script <- function(model_names, has_projection = FALSE, file) {
  header <- c(
